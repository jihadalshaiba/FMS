...
class Fruits_display extends StatefulWidget {
  // const Fruits_display({super.key});
  String id = '';
  Fruits_display(String a) {
    this.id = a;
    doc = a;
  }
  @override
  State<Fruits_display> createState() => _Fruits_displayState();
}

class _Fruits_displayState extends State<Fruits_display> {
  @override
