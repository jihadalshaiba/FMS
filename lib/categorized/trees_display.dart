...
class trees_display extends StatefulWidget {
  // const trees_display({super.key});
  String id = '';
  trees_display(String a) {
    this.id = a;
    doc = a;
  }
  @override
  State<trees_display> createState() => _trees_displayState();
}

class _trees_displayState extends State<trees_display> {
  @override
