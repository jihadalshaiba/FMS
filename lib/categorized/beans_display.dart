...
class beans_display extends StatefulWidget {
  // const beans_display({super.key});
  String id = '';
  beans_display(String a) {
    this.id = a;
    doc = a;
  }

  @override
  State<beans_display> createState() => _beans_displayState();
}

class _beans_displayState extends State<beans_display> {
  @override
